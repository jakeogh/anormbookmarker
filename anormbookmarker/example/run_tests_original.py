...
#    # correctly raises exception:
#    # sqlalchemy.exc.IntegrityError: (psycopg2.IntegrityError) new row for relation "tag_relationship"
#    # violates check constraint "tag_relationship_check"
